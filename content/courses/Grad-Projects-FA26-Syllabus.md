...
MFA6009-004 Graduate Projects: Art & Technology / Sound Practices
Format: 7 Individual 60 minute meetings per semester arranged individually

Advising schedule will be determined on an individual basis with your faculty advisor via email.
## Faculty:

NAME: Douglas Rosman (he/him) (preferred name: Doug)
TITLE: Assistant Professor, AT/SP
EMAIL: drosman@saic.edu
OFFICE LOCATION: MacLean 405
## Course Description:

Graduate Projects advisors are expected to provide committed, one-to-one instruction in the service of enhancing students’ research practices and both expanding and deepening their intellectual engagement. References should be made to other practitioners and cultural entities of all types that might productively inform students’ practices. Where appropriate, skill building needs should be specified and supported. Creative and intellectual rigor should be expected of each student and modeled by the advising faculty member. Graduate Projects advisors also often function as attentive listeners, and this can be an important and productive form of student support as well.
## Learning Goals & Outcomes:

The course develops the habits, discipline, and commitments that underpin an individual practice and production, including establishing resources, time management, and skill building. 

The course teaches artists/designers how to make use of the feedback they receive from various sources, revise and reiterate based on feedback, and show academic progress throughout. 

The course is designed to reflect on the commentary and responses from the instructor to help artists/designers to articulate a position of their work within its field.
...
Recipients of federal aid must have begun attendance in classes for which their eligibility is based upon at the time of disbursement and, in the case of Federal Direct Loans (Subsidized, Unsubsidized, and PLUS), be enrolled at least half-time.
### Religious Holiday Observance

SAIC recognizes the diverse religious and cultural practices of our community. Students are expected to notify their instructors early in the semester to discuss reasonable accommodations for holidays they observe.
### Class Progress Reports (CPRs)

Progress Reports are an important tool in SAIC's academic support for students. The primary purpose of a Progress Report is to initiate further dialogue between the student and faculty member regarding concerns about a student's progress in their course. Instructors will submit CPRs through Navigate. The secondary purpose of Progress Reports is to make Academic Advising aware of faculty concerns. Academic Advisors review Progress Reports and reach out appropriately to students when a message (or combination of messages) indicates concern. 
...
Writing Center Hours (CST) Monday – Thursday: 9 AM - 7 PM and Friday: 9 AM - 5 PM

Though drop-ins are welcome, the best way to guarantee an appointment is to schedule one via [Navigate](https://www.saic.edu/writing-center). 

Email: [wcente@saic.edu](mailto:wcente@saic.edu)
Location: 116 S. Michigan Avenue, 10th Floor
Phone 312-499-4138
### Academic Misconduct
...
If you have difficulty affording groceries or accessing food every day, and/or do not have a safe and stable place to live, please contact the Office of Student Affairs - (312) 629-6800 / [studenthelp@saic.edu](mailto:studenthelp@saic.edu) during business hours. If you contact them after hours, someone will respond the next business day. 

You can also find links and resources at this site, curated by Student Affairs: [Student Support Resources and Information](https://www.saic.edu/student-support) 
#### SAIC Food Pantry

Spoonful Food Pantry is available to current SAIC students who are experiencing difficulty accessing food because of a financial emergency or ongoing constraints. Students can request a pre-packaged bag of non-perishable groceries (vegan and gluten free available) by completing the online [form](https://docs.google.com/forms/d/e/1FAIpQLSfF4uHeWFVjjkpuzdaDVe1SkmfEnYpdxohx2YbOSxKf4gflEg/viewform). 

Once approved, students will receive a pre-packaged bag of non-perishable groceries. 
### Wellness Center  
...
- Counseling Services: [counselingservices@saic.edu](mailto:counselingservices@saic.edu) and 312-499-4271 (press 1 to speak to a counselor after hours)
- Health Services: [healthservices@saic.edu](mailto:healthservices@saic.edu) and 312-499-4288 (After hours contact the 24-Hour Nurse Line at 877-924-7758)  
- Disability and Learning Resource Center: [dlrc@saic.edu](mailto:dlrc@saic.edu) and 312-499-4278
### Grades of Incomplete (INC)

Grades of INC (incomplete) are granted by the instructor only if the instructor believes that the student’s reason for the request is justified. Furthermore, students receiving an incomplete should have attended the majority of classes as well as regularly completed assignments prior to the last day to officially withdraw from the class. It is the responsibility of the student to contact the instructor regarding the completion of the incomplete grade. Incompletes must be changed within the first two weeks of the following regular semester, or the grade automatically changes to NCR (no credit).
### Extra Credit Policy

There are no extra credit opportunities associated with this course.  
### SAIC Audit Policy

Per SAIC’s Policy on non-credit enrollment, auditing this course is not permitted. Students wishing to participate in this course must be enrolled for credit.
### Digital Device Policy

The student use of various digital devices in class, such as laptops, phones, tablets, etc. should be limited only to appropriate use given the format of the class. Use of digital devices in class to do non-class related work will not be allowed or tolerated. Similarly, use of digital devices in class during screenings will not be allowed or tolerated. 

If a student has a software or hardware related problem please visit the [CRIT](https://www.saic.edu/crit) Help Desk on the 9th floor of the 112 S. Michigan (Maclean) Building for assistance addressing these issues.
### Artificial Intelligence (AI) Policy

In this course, the submission of any AI-generated work is strictly prohibited without advance, written permission from the instructor. Students are strongly encouraged to consult with their instructor if they are interested in utilizing AI tools (apps, etc.) to develop content they plan to submit for a course assignment. If students are not sure if a tool they plan to use is considered AI-facilitated, they are encouraged to ask their instructor. Submitting AI-generated content without receiving permission from the instructor to do so will be considered a violation of community rules for this course and may constitute a violation of the School’s Academic Misconduct Policy.
### Ombudsperson
...
International Student Affairs provides guidance and advising on F-1/J-1 visa related regulations and provides support in the form of workshops, presentations, one-on-one advising, and social events to help international students achieve their academic and personal goals. Students who wish to meet with an international student adviser can schedule an appointment through the Navigate Student App or desktop site [here](https://www.saic.edu/crit/resources/navigate). Students are also encouraged to email intaff@saic.edu with questions or visit in person during [Drop-In Advising](https://www.saic.edu/international-affairs) hours.
### The Visiting Artist Program 

The primary mission of the Visiting Artists Program (VAP) is to educate and foster a greater understanding and appreciation of contemporary art and culture through discourse. As such, the VAP is central to SAIC's interdisciplinary curriculum.Additional information can be found [here](https://saic.instructure.com/courses/2252725/pages/visiting-artists-program). 
